...
const navItems: NavItem[] = [
  ...
  { href: "/customers/c1", label: "Customers", icon: Users },
  ...
  return (
    <>
      ...
      <div className="px-4 pb-4">
        ...
        <button type="button" className="flex w-full items-center gap-3 rounded-lg p-2 text-left hover:bg-zinc-100">
          <Avatar className="size-8">
            <AvatarFallback className="bg-zinc-200 text-xs font-medium text-zinc-700">KL</AvatarFallback>
          </Avatar>
          <div className="min-w-0 flex-1">
            <div className="truncate text-sm font-medium">Kim Lewis</div>
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="flex h-14 shrink-0 items-center border-b border-zinc-200 bg-white px-4 lg:hidden">
          ...
          <Avatar className="ml-auto size-8">
            <AvatarFallback className="bg-zinc-100 text-xs text-zinc-700">KL</AvatarFallback>
          </Avatar>
        </header>
